...
<body>
<?php
     include('/OSPanel/modules/system/html/openserver/phpmyadmin/final/nav.php');
    ?>
    <div class="mainPage">
        ...
        <div class="firstPicture">
            <img src="../img/shymkent-pic-nature.jpg" alt="">
            <img src="../img/shymkent-pic-nature2.jpg" alt="">
            <br>
            <span>The cave is so big that even a small forest is growing inside.</span>
        </div>
        <div class="popup-image">
            <span>&times;</span>
            <img src = "../img/shymkent-pic-about1.jpg" alt = " ">
        </div> 
        ...
        <div class="secondPicture">
            <img src="../img/shymkent-pic-nature3.jpg" alt="">
            <img src="../img/shymkent-pic-nature4.jpg" alt="">
        ...
        <div class="thirdPicture">
            <img src="../img/shymkent-pic-nature6.jpg" alt="">
            <img src="../img/shymkent-pic-nature67jpg.jpg" alt="">
        ...
        <div class="fourthPicture">
            <img src="../img/shymkent-pic-nature7.jpg" alt="">
            <img src="../img/shymkent-pic-nature78jpg.jpg" alt="">
        ...
        <div class="fivethPicture">
            <img src="../img/shymkent-pic-nature8.jpg" alt="">
        ...
        <div class="sixthPicture">
            <img src="../img/shymkent-pic-nature10.jpg" alt="">
