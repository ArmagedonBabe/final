...
<body>
    ...
    <div class="mainPage">
        ...
        <div class="imgCollage">
            <img class = "imgG"src="../img/shymkent-pic-about1.jpg" alt="fasf">
            <img class = "imgG" src="../img/shymkent-pic-about2.jpg" alt="fdsfsd">
            <img class = "imgG" src="../img/shymkent-pic-about3.jpg" alt="fdsf">
        ...
        <div class="imgCollage">
            <img src="../img/shymkent-pic-about4.jpg" alt="fasf">
            <img src="../img/shymkent-nature2.jpg" alt="fdsfsd">
            <img src="../img/shymkent-pic-about5.jpg" alt="fdsf">
